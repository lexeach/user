 ...
 */
class ContractFormatedValue extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    render() {
        ...
        switch (this.props.type) {
            ...
            case 'uint256':
                return (
                    <>
                        {(this.props.mode === "e18" || this.props.value >=1000)
...
ContractFormatedValue.propTypes = {
    type: PropTypes.string,
    mode: PropTypes.oneOf(['raw', 'e18']),
};

export default ContractFormatedValue;